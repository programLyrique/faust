...
BinOp* gBinOpTable[] = {
    ...
    new BinOp("*","mul_vec","mul_scal", &mulNode, &isOne, &isOne, 8, isZero, isZero),
    ...
    new BinOp("&","and_vec","and_scal", &andNode, &isMinusOne, &isMinusOne, 8, isZero, isZero),
...
BinOp* gBinOpLateqTable[] = {
	...
	new BinOp("+","add_vec","add_scal", &addNode, &isZero, &isZero, 6),
    new BinOp("-","sub_vec","sub_scal", &subNode, &noNtrl, &isZero, 7),
    new BinOp("*","mul_vec","mul_scal", &mulNode, &isOne, &isOne, 8, isZero, isZero), // \DeclareMathSymbol{*}{\mathbin}{symbols}{"01}
    ...
    new BinOp("\\wedge","and_vec","and_scal", &andNode, &isMinusOne, &isMinusOne, 8, isZero, isZero),
